...
a_to_jolie = [i for i in angelina_jolie if i.lower().count('а')>2]
two_to_pitt = [i.upper() for i in brad_pitt if i.find('2')!=-1]
oshen_to_clooney = [i.replace('Оушена','Клуни') if i.find('Оушена')!=-1 else i for i in george_clooney ]
