...
life_jolie = list(filter(lambda x: 'жизнь' in x.lower(),angelina_jolie))
peace_pitt = list(filter(lambda x: 'мир' in x.lower(),brad_pitt))
love_clooney = list(filter(lambda x: 'любовь' in x.lower(),george_clooney))
