...
only_jolie = len(set(angelina_jolie)-set(brad_pitt)-set(george_clooney))
only_pitt = len(set(brad_pitt)-set(angelina_jolie)-set(george_clooney))
only_clooney = len(set(george_clooney)-set(brad_pitt)-set(angelina_jolie))
