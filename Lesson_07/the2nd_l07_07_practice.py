...
a_jolie, a_pitt, a_clooney = sum([i.lower().count('а') for i in angelina_jolie]),sum([i.lower().count('а') for i in brad_pitt]),sum([i.lower().count('а') for i in george_clooney])
f = lambda x: x.lower().find('ф')
f_to_jolie, f_to_pitt, f_to_clooney = [i for i in angelina_jolie if f(i)!=-1],[i for i in brad_pitt if f(i)!=-1],[i for i in george_clooney if f(i)!=-1]
