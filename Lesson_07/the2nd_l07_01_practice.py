...
pitt_and_jolie = set(angelina_jolie).intersection(set(brad_pitt))
pitt_and_clooney = set(george_clooney).intersection(set(brad_pitt))
clooney_and_jolie = set(angelina_jolie).intersection(set(george_clooney))
